...
bool CutestProblem::all_inequalities_are_variable_bounds() const {
  return std::all_of(constant_singleton_inequalities_.begin(),
                     constant_singleton_inequalities_.end(),
