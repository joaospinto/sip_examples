...
inline void evaluate_common(const sip::ModelCallbackInput &mci, double *f,
                            double *gradient_f,
                            double *upper_hessian_lagrangian, double *g) {
...
inline void evaluate_qdldl(const sip::ModelCallbackInput &mci, double *f,
...
inline void evaluate_slacg(const sip::ModelCallbackInput &mci, double *f,
                           double *gradient_f, double *g,
                           double *upper_hessian_lagrangian,
                           double *jacobian_g) {
  evaluate_common(mci, f, gradient_f, upper_hessian_lagrangian, g);
